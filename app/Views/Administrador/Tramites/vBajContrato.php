    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sm btn-success" id="botonGuardar">Dar Baja</button>
            </div>
        </div>
    </div>
</div>
...
<script src="/public/JScript/Administrador/Tramites/jsaBajContrato.js"></script>
