<div class="container-fluid fondo-estado vh-100 bg-light p-2">
    ...
    <div class="card">
        ...
        <div class="card-footer bg-white p-1 fuente-12p">
            ...
            <div><small>Continue <a href="catperfiles">aquí</a> para agregar y armar perfiles.</small></div>
        </div>
    </div>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation" id="formAreasCRUD"></form>
            </div>
...
<script src="/public/JScript/Sistema/Catalogos/jsPuestos.js"></script>
