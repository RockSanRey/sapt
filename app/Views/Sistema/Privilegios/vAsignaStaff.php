<div class="container-fluid fondo-estado vh-100 bg-light pt-2">
    ...
    <div class="card">
        ...
        <div class="card-footer bg-white p-1 fuente-12p">
            ...
            <div><small>Registre nuevos puestos <a href="catpuestos">aquí</a>.</small></div>
            <div><small>Registre nuevos perfiles <a href="catperfiles">aquí</a>.</small></div>
        </div>
    </div>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation" id="formCRUD">
                </form>
            </div>
