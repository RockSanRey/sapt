<div class="container-fluid fondo-estado vh-100 bg-light p-2">
    ...
    <div class="card">
        ...
        <div class="card-footer bg-white p-1 fuente-12p">
            ...
            <small>Registrar nuevas opciones a submenu nivel 3 <a href="/menunivelc" class="link">aquí</a></small>
        </div>
    </div>
</div>
<!-- Modal -->
...
<script src="/public/JScript/Sistema/Menuopcion/jsMenuNivD.js"></script>
