<div class="container-fluid fondo-estado vh-100 bg-light p-2">
    ...
    <div class="card">
        ...
        <div class="card-footer bg-white p-1 fuente-12p">
            <small>Registrar nuevas opciones en menú nivel 2 <a href="/menunivelb" class="link">aquí</a></small><br>
            <small>Registrar nuevas opciones en menú nivel 3 <a href="/menunivelc" class="link">aquí</a></small><br>
            <small>Registrar nuevas opciones en menú nivel 4 <a href="/menuniveld" class="link">aquí</a></small>
        </div>
    </div>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <div class="modal-title" id="staticCrearRegistro">Nuevo registro</div>
            </div>
            <div class="modal-body">
                <form class="needs-validation" id="formMenuCRUD">
                </form>
            </div>
...
<script src="/public/JScript/Sistema/Menuopcion/jsMenuNivA.js"></script>
