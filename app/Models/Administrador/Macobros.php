...
class Macobros extends Model
{
    ...
    public function cargarDatosUsuarioGenerales($id)
    {
        try {
            ...
            if($resultado->getNumRows()>0){
                log_message('info','[PAGOSERVICIO|Async/Q] Generando datos desde consulta para continuar carga de datos de usuario');
            ...
            if($resultado0->getNumRows()>0){
                log_message('info','[PAGOSERVICIO|Async/Q] Generando datos desde consulta para renderizar lista de contratos');
